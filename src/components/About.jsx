                  ...
                  <Col lg={8} align='center'>
                    <Card className="nbcard">
                      <Card.Body>
                        ...
                        <br></br>
                        <Card.Text>
                          <p>I am a <strong>Sophomore student</strong> at K.L.E S Nijalinagappa College, Department of <strong>Computer Science and Technology</strong>, I am a <strong>passionate full stack developer</strong> and believe in <strong>networking</strong> a lot. Many things excite me in this expanse of technology, and I like to explore and keep my options open all the time. I am up for challenges that take me by surprise. I'm comfortable working on any domain if I find the project is interesting and challenging. You can imagine me focused on the laptop screen and typing or taking down notes. Apart from technical things, I enjoy travelling.<br></br>
                  ...
                  <Col lg={4} align='center'>
                    <Card className="nbcard">
                      <Card.Body>
                        ...
                        <br></br>
                        <a href="https://www.linkedin.com/in/rashmi-n-76934919a/" target="_blank" rel="noreferrer noopener">
                          <Button variant={darkMode ? "outline-light" : "outline-dark"} className='a'>
                            <FontAwesomeIcon className="dark" size="lg" icon={faLinkedin}/> Rashmi N
                          </Button>
                        </a>
