                ...
                <Col lg={6} xs={12}>
                    ...
                    <Card className="skill-nbcard">
                        <Card.Body>
                            ...
                            <Card.Text>C Programming, Java, Python, JavaScript</Card.Text>
                        </Card.Body>
                    </Card>
                    <Card className="skill-nbcard">
                        <Card.Body >
                            <Card.Title>Technologies</Card.Title>
                            <Card.Text>HTML, CSS, Bootstrap, ReactJs, MongoDB, Express</Card.Text>
                        </Card.Body>
                    </Card>
                    <Card className="skill-nbcard">
                        <Card.Body >
                            <Card.Title>Others</Card.Title>
                            <Card.Text>MS office, Git</Card.Text>
                        </Card.Body>
                    </Card>
                </Col>
                </Row>
